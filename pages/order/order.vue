		...
		<view class="footer">
			...
			<uni-popup ref="popup" type="bottom">
				...
				<view class="pay-choose">
					<view class="pay-list">
<!-- 						<view class="pay-item" @click="goAliPay(1)">
							<view class="pay-yue"><text></text>余额支付</view>
							<text> > </text>
						</view>
						<view class="pay-item" @click="goAliPay(2)">
							<view class="pay-yinlian"><text></text>银联支付</view>
							<text> > </text>
						</view> -->
						<view class="pay-item" @click="goAliPay(3)">
	...
	export default {
		...
		data() {
			return {
				...
				userAddr:{},
				orderInfo:'alipay_sdk=alipay-sdk-java-dynamicVersionNo&app_id=2019093067917773&biz_content=%7B%22body%22%3A%22%E8%B4%AD%E4%B9%B0%E5%95%86%E5%93%81%3A%E7%A6%8F%E9%BC%8E%E7%99%BD%E8%8C%B6%22%2C%22out_trade_no%22%3A%222019101720095635828%22%2C%22product_code%22%3A%22QUICK_MSECURITY_PAY%22%2C%22subject%22%3A%22%E8%B4%AD%E4%B9%B0%E5%95%86%E5%93%81%3A%E7%A6%8F%E9%BC%8E%E7%99%BD%E8%8C%B6%22%2C%22timeout_express%22%3A%2230m%22%2C%22total_amount%22%3A%220.01%22%7D&charset=UTF-8&format=json&method=alipay.trade.app.pay&notify_url=http%3A%2F%2Flocalhost%2Fv1.0%2Fpaymentchannel%2Ftopup%2Falipay%2Fnotify_call&return_url=http%3A%2F%2Flocalhost%2Fv1.0%2Fpaymentchannel%2Ftopup%2Fsdjpaysuccess&sign=VmwQmuypX6xRsXt7CTY8SsNUCQlTovFd1cKTGVCVSDcfaZSv3yGhH8z0Zfwp%2BRMvWXQGfhWptbRWpUcU7Q8LxIASGEt%2FZxfIRhpaIKg1MKq6o9aK5zU3zwyPgvWq86JWLSNJX6Os3Doc8GkseeUEzfUnsudLRsgA88T1s%2F81MblMR%2Fb3KDmxfYheAPNNu5daX3pFN%2Bb6X3rFnMWH%2FdV%2BZhkgPexVbPvHTu6I54uCS3sYjf4wYcZ9w1p2UXx4eOpEYymh8KX5e939qzTagMQFVidoRweD4JD3nrHgCYtBD8UaNKj%2FDRGioFwMO6%2BLRRqjQ4BD6u260kWJD5C4vHv19A%3D%3D&sign_type=RSA2&timestamp=2019-10-17+20%3A09%3A56&version=1.0',
				num:1,
			}
		},
		onShow:function(option){
			try {
				console.log(2)
			    const value = uni.getStorageSync('chooseOrderIndex');
			    if (value || value === 0) {
					// console.log(3)
			        // console.log('value:'+value);
					this.userAddr = getApp().globalData.userAddr[value]
			    }else{
		...
		methods: {
			...
			goAliPay(paymentMethod){
				...
				uni.request({
					url: `${baseURL}/v1.0/good/order/save/${token}?goodsId=${goodsId}&addressId=${addressId}&number=${number}&paymentMethod=${paymentMethod}&brandId=100195`,
